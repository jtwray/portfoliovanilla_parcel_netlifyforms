...
const processForm = form => {
  ...
  fetch("/", {
    ...
    .then(() => {
      form.innerHTML = `<div class="form--success">Success! Your message has been delivered ${datetime}. Thanks for reaching out. I'll be in touch ASAP.</div>`;
    })
    .catch(error => {
